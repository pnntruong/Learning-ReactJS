...
const UserSetting = ({ isShow, setIsShow }) => {
  ...
  return (
    <div className="absolute z-10 top-0 bg-white border-blue-300 w-full lg:w-2/4 self-center rounded-lg border-2 flex flex-col">
      ...
      <div className="flex items-center flex-col">
        <img className="rounded-full my-4" src={user.photoURL} alt={user.email} />
